...
using WindowsAppStudio.Services;
...
namespace WindowsAppStudio
{
    ...
    {
        private Guid APP_ID = new Guid("82436223-adc7-4422-b43f-3fed935e5aaf");
        ...
        private void UpdateAppTiles()
        {
            ...
            if (init == null || (init is bool && !(bool)init))
            {
                ...
                tiles.Add("2f8295ae34fcc1f2", "DataImages/Tile1.jpg");
                tiles.Add("2f8295ae34fcc1f3", "DataImages/Tile2.jpg");
                tiles.Add("2f8295ae34fcc1f4", "DataImages/Tile3.jpg");
                tiles.Add("2f8295ae34fcc1f5", "DataImages/Tile4.jpg");
                tiles.Add("2f8295ae34fcc1f6", "DataImages/Tile5.jpg");
