...
{
    public class DetailConfig : SectionConfigBase<LocalStorageDataConfig, MenuSchema>
    {
        ...
        public override LocalStorageDataConfig Config
        {
            get
            {
                ...
                {
                    FilePath = "/Assets/Data/Detail.json"
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("DetailListPage");
            }
        }
